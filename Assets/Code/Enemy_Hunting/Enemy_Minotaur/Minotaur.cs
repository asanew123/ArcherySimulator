...
public class Minotaur : MonoBehaviour
{
    ...
    public float HP = 280;              // 기본 체력   Easy : 140       Normal : 210        Hard : 280
    public float Max_HP;
    public int Damage = 15;                  // 기본 데미지      Easy : 25    Normal : 35     Hard : 45;     
    ...
    void Update()
    {
        ...
        {
            Minotaur_anim.SetBool("Time_Stop", false);
            Enemy_Ctrl();
        }
        else if(Play.Time_Stop == true)
        {
            Minotaur_anim.SetBool("Time_Stop", true);
        }
    }
    ...
    void Enemy_Ctrl()
    {
        ...
        if(Death == false)
        {
            if(Attack_Use == true)
            {
                Minotaur_anim.SetBool("Attack", true);
            ...
            else if(Attack_Use == false)
            {
                if(Damage_Cheak == true)
                {
                    ...
                    Minotaur_anim.SetBool("Run", true);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Minotaur_anim.SetBool("Walk", true);
        }
    ...
    void Die()
    {
        if(HP <= 0)
        {
            HP = 0;
            Death = true;
            Minotaur_anim.SetBool("Die", true);
            nav.enabled = false;
        }
        ...
        {
            death_time = 0;
            Minotaur_anim.SetBool("Die_Cheak", true);
            rb.isKinematic = true;
            Destroy(this.gameObject, 2f);
            G_M.Kill_Count += 1;
            G_M.Kill_Cheak = true;
    ...
    void Enemy_UI()
    {
        HP_Bar.fillAmount = HP / (70 + (70 * Game_Level)); 
