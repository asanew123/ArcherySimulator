...
public class Eagle_Fantasy : MonoBehaviour
{
    ...
    public float HP = 60;              // 기본 체력   Easy : 60       Normal : 70        Hard : 80
    public float Max_HP;
    ...
    void Enemy_UI()
    {
        HP_Bar.fillAmount = HP / (50 + (10 * Game_Level)); 
