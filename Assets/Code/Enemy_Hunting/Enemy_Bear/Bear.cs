...
public class Bear : MonoBehaviour
{
    ...
    public float HP = 100;              // 기본 체력   Easy : 100       Normal : 200        Hard : 300
    public float Max_HP;
    public int Damage = 15;                  // 기본 데미지      Easy : 20    Normal : 30     Hard : 40;     
    ...
    void Update()
    {
        ...
        {
            B_anim.SetBool("Time_Stop", false);
            Enemy_Ctrl();
        }
        else if(Play.Time_Stop == true)
        {
            B_anim.SetBool("Time_Stop", true);
        }
    }
    ...
    void Enemy_UI()
    {
        HP_Bar.fillAmount = HP / (100 * Game_Level); 
