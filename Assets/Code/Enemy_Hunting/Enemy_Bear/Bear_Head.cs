...
public class Bear_Head : MonoBehaviour
{
    public GameObject B;
    ...
    void Start()
    {
        ...
        Bea = B.transform.GetComponent<Bear>();
    ...
    private void OnTriggerEnter(Collider other)
    {
        if(other.tag == "Arrow" && Play.damage > 0)
        {
            ...
            Bea.HP -= (Play.damage * Play.Head_M);
            Bea.Damage_Cheak = true;
            Shot_M.All_False();
            ...
            Play.damage = 0;
            Debug.Log("곰 머리 피격");
            if((Bea.HP -= (Play.damage * Play.Head_M)) <= 0)
            {
