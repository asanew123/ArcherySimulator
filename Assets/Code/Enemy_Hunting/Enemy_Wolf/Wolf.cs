...
public class Wolf : MonoBehaviour
{
    ...
    public float HP = 80;              // 기본 체력   Easy : 80       Normal : 120        Hard : 160
    public float Max_HP;
    public int Damage = 15;                  // 기본 데미지      Easy : 15    Normal : 20     Hard : 25;     
    ...
    void Update()
    {
        ...
        {
            Wolf_anim.SetBool("Time_Stop", false);
            Enemy_Ctrl();
        }
        else if(Play.Time_Stop == true)
        {
            Wolf_anim.SetBool("Time_Stop", true);
        }
    }
    ...
    void Die()
    {
        ...
        {
            death_time = 0;
            Wolf_anim.SetBool("Die_Cheak", true);
            rb.isKinematic = true;
            Destroy(this.gameObject, 2f);
            G_M.Kill_Count += 1;
            G_M.Kill_Cheak = true;
    ...
    void Enemy_UI()
    {
        HP_Bar.fillAmount = HP * 0.25f / (10*(1+Game_Level)); 
